...
const lightTheme: Theme = {
  ...
  startupAccent: 'rgb(138,92,58)', // Free Code deep brown accent
...
const darkTheme: Theme = {
  ...
  claude: 'rgb(215,119,87)', // Claude orange
  startupAccent: 'rgb(191,146,110)', // Free Code deep brown accent for dark backgrounds
