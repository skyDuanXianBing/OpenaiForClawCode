...
function PromptInput({
  ...
  const mainLoopModel_ = selectedModel?.modelId ?? null;
  const mainLoopModelForSession = selectedModelForSession?.modelId ?? null;
  ...
  const handleModelSelect = useCallback((model: string | null, _effort: EffortLevel | undefined, selectedModelValue?: SelectedModel | null) => {
