...
import { resolveInitialSelectedModel } from '../utils/model/selection.js'
...
export type AppState = DeepImmutable<{
  ...
  verbose: boolean
  selectedModel: SelectedModel | null // provider-aware persisted runtime selection
  selectedModelForSession: SelectedModel | null // provider-aware session-only override
...
export function getDefaultAppState(): AppState {
  ...
  const selectedModel = resolveInitialSelectedModel({
    runtimeSelectedModel: getSelectedModelOverride(),
    settings,
  })
