...
import { setRuntimeModelOverride } from '../bootstrap/state.js';
...
import { createRuntimeSelectedModelFromValue } from '../utils/model/runtimeSelectedModel.js';
        ...
        try {
          ...
          const handle_0 = await initReplBridge({
            ...
            onSetModel(model) {
              ...
              setRuntimeModelOverride(resolved);
              setAppState(prev_10 => {
                const nextSelectedModel = createRuntimeSelectedModelFromValue(resolved, prev_10.selectedModelForSession ?? prev_10.selectedModel);
                const previousModelId = prev_10.selectedModelForSession?.modelId ?? null;
                const nextModelId = nextSelectedModel?.modelId ?? null;
                if (previousModelId === nextModelId) return prev_10;
                return {
                  ...prev_10,
                  selectedModelForSession: nextSelectedModel
                };
              });
            },
